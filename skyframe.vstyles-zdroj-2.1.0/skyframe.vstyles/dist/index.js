...
var t = (k, f) => api.t(k, f);
var { useState: useState2, useEffect: useEffect2 } = react_shim_default2;
var STYLES = [
...
function ToolPanel() {
  ...
  return /* @__PURE__ */ react_shim_default2.createElement("div", { className: "p-3 flex flex-col gap-3 text-sm" }, !s.media && /* @__PURE__ */ react_shim_default2.createElement("div", { className: "text-xs text-text-dim bg-bg-card border border-border rounded-lg p-2" }, t("hint_media", "Otvor fotku alebo video v Editore \u2014 \u0161t\xFDl sa aplikuje na\u0148.")), s.aiOk === false && /* @__PURE__ */ react_shim_default2.createElement("div", { className: "text-xs text-red-400 bg-red-500/10 border border-red-500/30 rounded-lg p-2" }, "\u26A0 ", t("need_ai", "AI \u0161t\xFDly vy\u017Eaduj\xFA AI licenciu a ONNX Runtime \u2014 aktivuj ich v AI centre.")), /* @__PURE__ */ react_shim_default2.createElement("div", { className: "grid grid-cols-2 gap-2" }, STYLES.map((st) => /* @__PURE__ */ react_shim_default2.createElement(Card, { key: st.id, style: st, active: s.selected === st.id, installed: !!s.installed[st.id], img: s.previews[st.id] }))), s.selected && /* @__PURE__ */ react_shim_default2.createElement(react_shim_default2.Fragment, null, /* @__PURE__ */ react_shim_default2.createElement(
    "button",
    {
  ...
  ), /* @__PURE__ */ react_shim_default2.createElement("label", { className: "text-xs text-text-dim flex flex-col gap-1" }, t("intensity", "Intenzita"), " \u2014 ", s.intensity, " %", /* @__PURE__ */ react_shim_default2.createElement(
    "input",
    {
      type: "range",
      min: 10,
  ...
  )), isVideo && /* @__PURE__ */ react_shim_default2.createElement("div", { className: "flex flex-wrap gap-3 text-xs text-text-dim" }, /* @__PURE__ */ react_shim_default2.createElement("label", { className: "flex flex-col gap-1" }, "FPS", /* @__PURE__ */ react_shim_default2.createElement(
    "select",
    {
      value: s.fps,
    ...
    /* @__PURE__ */ react_shim_default2.createElement("option", { value: "2160p" }, "4K"),
    /* @__PURE__ */ react_shim_default2.createElement("option", { value: "1080p" }, "1080p"),
    /* @__PURE__ */ react_shim_default2.createElement("option", { value: "1024p" }, "1024p"),
    /* @__PURE__ */ react_shim_default2.createElement("option", { value: "720p" }, "720p"),
    /* @__PURE__ */ react_shim_default2.createElement("option", { value: "480p" }, "480p")
  )), /* @__PURE__ */ react_shim_default2.createElement("label", { className: "flex items-end gap-1.5 pb-1" }, /* @__PURE__ */ react_shim_default2.createElement("input", { type: "checkbox", checked: s.keepAudio, onChange: (e) => store.setState({ keepAudio: e.target.checked }) }), t("keep_audio", "Zvuk"))), /* @__PURE__ */ react_shim_default2.createElement("div", { className: "text-[11px] text-text-dim leading-snug border-t border-border pt-2" }, "\u{1F4A1} ", t("how", "\u0160t\xFDl je prv\xFD krok z\xE1sobn\xEDka \u2014 potom m\xF4\u017Ee\u0161 prida\u0165 Filtre alebo Portr\xE9t. Export je jeden s\xFAbor."))));
}
function Card({ style, active, installed, img }) {
  ...
  return /* @__PURE__ */ react_shim_default2.createElement(
    ...
    /* @__PURE__ */ react_shim_default2.createElement("div", { className: "relative aspect-[3/2] bg-bg" }, img ? /* @__PURE__ */ react_shim_default2.createElement("img", { src: img, alt: style.id, className: "w-full h-full object-cover" }) : /* @__PURE__ */ react_shim_default2.createElement("div", { className: "w-full h-full flex items-center justify-center text-text-dim" }, "\u2026"), !installed && /* @__PURE__ */ react_shim_default2.createElement(
      ...
      dl ? /* @__PURE__ */ react_shim_default2.createElement("span", { className: "text-[10px]" }, Math.round(dl.pct), " %") : /* @__PURE__ */ react_shim_default2.createElement(react_shim_default2.Fragment, null, /* @__PURE__ */ react_shim_default2.createElement("span", null, "\u2B07"), /* @__PURE__ */ react_shim_default2.createElement("span", { className: "text-[9px]" }, style.mb, " MB"))
    ), active && installed && /* @__PURE__ */ react_shim_default2.createElement("div", { className: "absolute top-1 right-1 bg-accent text-white text-[9px] px-1 py-0.5 rounded" }, "\u2713")),
    /* @__PURE__ */ react_shim_default2.createElement("div", { className: "px-1.5 py-1 bg-bg-card" }, /* @__PURE__ */ react_shim_default2.createElement("div", { className: "text-[10px] font-medium truncate" }, t(style.id, style.id)))
  );
}
...
function VStylesInfo() {
  return /* @__PURE__ */ react_shim_default2.createElement("div", { className: "p-4 text-sm text-text-dim" }, "\u{1F3AC} ", t("info", "\u0160t\xFDly videa s\xFA n\xE1stroj Editora \u2014 otvor Editor (\u{1F39B}\uFE0F) a vyber ich vpravo."));
}
export {
