...
function Section({ title, open, onToggle, count, children }) {
  return /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { marginBottom: 10 } }, /* @__PURE__ */ framesbuild_shim_default.createElement(
    "button",
    {
      onClick: onToggle,
      style: {
    ...
    /* @__PURE__ */ framesbuild_shim_default.createElement("span", { style: { display: "inline-block", transition: "transform 120ms", transform: open ? "rotate(90deg)" : "none" } }, "\u25B6"),
    /* @__PURE__ */ framesbuild_shim_default.createElement("span", null, title),
    /* @__PURE__ */ framesbuild_shim_default.createElement("span", { style: { opacity: 0.6 } }, "(", count, ")")
  ), open && children);
}
var CURVE_W = 232;
var CURVE_H = 150;
function CurveEditor({ points, onChange, onLive }) {
  const ref = framesbuild_shim_default.useRef(null);
  const drag = framesbuild_shim_default.useRef(-1);
  ...
  framesbuild_shim_default.useEffect(() => {
  ...
  return /* @__PURE__ */ framesbuild_shim_default.createElement(
    "canvas",
    {
      ref,
      width: CURVE_W,
...
function Wheel({ value, onChange, label, onLive }) {
  const ref = framesbuild_shim_default.useRef(null);
  const dragging = framesbuild_shim_default.useRef(false);
  const [local, setLocal] = useState2(null);
  ...
  const S = WHEEL_R * 2 + 8;
  return /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 2 } }, /* @__PURE__ */ framesbuild_shim_default.createElement(
    "canvas",
    {
      ref,
      width: S,
  ...
  ), /* @__PURE__ */ framesbuild_shim_default.createElement("span", { style: { fontSize: 10, opacity: 0.7 } }, label));
}
function FiltersField({ value, onChange, ctx }) {
  ...
  const card = (p) => {
    ...
    return /* @__PURE__ */ framesbuild_shim_default.createElement("div", { key: p.id, style: { position: "relative" } }, /* @__PURE__ */ framesbuild_shim_default.createElement(
      "button",
      {
        onClick: () => pick(p),
        style: {
      ...
      thumb ? /* @__PURE__ */ framesbuild_shim_default.createElement(
        "img",
        {
          src: thumb,
          alt: presetName(p),
      ...
      ) : /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { width: "100%", aspectRatio: "3/2", borderRadius: 6, marginBottom: 4, background: "rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, opacity: 0.4 } }, "\u2026"),
      /* @__PURE__ */ framesbuild_shim_default.createElement("span", { style: { fontSize: 11 } }, presetName(p))
    ), !p.builtin && /* @__PURE__ */ framesbuild_shim_default.createElement(
      "button",
      {
  ...
  return /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { display: "flex", flexDirection: "column", minHeight: 0 } }, /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { marginBottom: 12 } }, /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 12, opacity: 0.8, marginBottom: 4 } }, /* @__PURE__ */ framesbuild_shim_default.createElement("span", null, t("intensity", "Intenzita")), /* @__PURE__ */ framesbuild_shim_default.createElement("span", null, v.intensity, " %")), /* @__PURE__ */ framesbuild_shim_default.createElement(
    "input",
    {
      type: "range",
      min: 0,
  ...
  )), /* @__PURE__ */ framesbuild_shim_default.createElement("label", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: 13, marginBottom: 8, cursor: "pointer" } }, /* @__PURE__ */ framesbuild_shim_default.createElement(
    "input",
    {
      type: "checkbox",
      checked: v.skyOnly,
  ...
  ), "\u2601\uFE0F ", t("sky_only", "Len svetl\xE9 partie (obloha)")), v.skyOnly && /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { marginLeft: 4, marginBottom: 8 } }, /* @__PURE__ */ framesbuild_shim_default.createElement("label", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: 13, cursor: "pointer" } }, /* @__PURE__ */ framesbuild_shim_default.createElement(
    "input",
    {
      type: "checkbox",
      checked: v.aiMask,
    ...
    /* @__PURE__ */ framesbuild_shim_default.createElement("span", { style: { display: "inline-block", transition: "transform 120ms", transform: s.openGrade ? "rotate(90deg)" : "none" } }, "\u25B6"),
    /* @__PURE__ */ framesbuild_shim_default.createElement("span", null, t("grade_section", "Krivky a farby"))
  ), s.openGrade && /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { marginTop: 6, display: "flex", flexDirection: "column", gap: 10 } }, /* @__PURE__ */ framesbuild_shim_default.createElement(
    CurveEditor,
    {
  ...
  ), /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, /* @__PURE__ */ framesbuild_shim_default.createElement(
    "button",
    {
  ...
  ), /* @__PURE__ */ framesbuild_shim_default.createElement("span", { style: { fontSize: 10, opacity: 0.5, alignSelf: "center" } }, t("curve_hint", "klik = bod \xB7 dvojklik = zmaza\u0165"))), /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { display: "flex", justifyContent: "space-around" } }, /* @__PURE__ */ framesbuild_shim_default.createElement(Wheel, { label: t("wheel_shadows", "Tiene"), value: v.wheels.s, onLive: (wv) => sendLive(void 0, { ...v.wheels, s: wv }), onChange: (wv) => setV({ wheels: { ...v.wheels, s: wv } }) }), /* @__PURE__ */ framesbuild_shim_default.createElement(Wheel, { label: t("wheel_midtones", "Stredy"), value: v.wheels.m, onLive: (wv) => sendLive(void 0, { ...v.wheels, m: wv }), onChange: (wv) => setV({ wheels: { ...v.wheels, m: wv } }) }), /* @__PURE__ */ framesbuild_shim_default.createElement(Wheel, { label: t("wheel_highlights", "Svetl\xE1"), value: v.wheels.h, onLive: (wv) => sendLive(void 0, { ...v.wheels, h: wv }), onChange: (wv) => setV({ wheels: { ...v.wheels, h: wv } }) })), /* @__PURE__ */ framesbuild_shim_default.createElement("span", { style: { fontSize: 10, opacity: 0.5, textAlign: "center" } }, t("wheel_hint", "\u0165ahaj bodku \xB7 dvojklik = reset kolieska")), /* @__PURE__ */ framesbuild_shim_default.createElement(
    "button",
    {
  ...
  ), s.saveError && /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { color: "#f87171", fontSize: 11, marginTop: -4, marginBottom: 8 } }, t("save_failed", "Ulo\u017Eenie zlyhalo"), ": ", s.saveError), /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { paddingRight: 2 } }, /* @__PURE__ */ framesbuild_shim_default.createElement(
    Section,
    {
    ...
    s.presets.length === 0 ? /* @__PURE__ */ framesbuild_shim_default.createElement("p", { style: { fontSize: 11, opacity: 0.6, margin: "4px 0 8px" } }, t("no_custom", "Zatia\u013E \u017Eiadne \u2014 vytvor si vlastn\xFD z fotky tla\u010Didlom vy\u0161\u0161ie.")) : /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 8 } }, s.presets.map(card))
  ), /* @__PURE__ */ framesbuild_shim_default.createElement(
    Section,
    {
    ...
    /* @__PURE__ */ framesbuild_shim_default.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 8 } }, BUILTIN_PRESETS.map(card))
  )), (v.style || v.curves || wheelsActive(v.wheels)) && /* @__PURE__ */ framesbuild_shim_default.createElement(
    "button",
    {
...
function FiltersInfo() {
  return /* @__PURE__ */ framesbuild_shim_default.createElement("div", { className: "h-full flex items-center justify-center" }, /* @__PURE__ */ framesbuild_shim_default.createElement("div", { className: "text-center max-w-sm rounded-2xl border border-border bg-bg-card p-8" }, /* @__PURE__ */ framesbuild_shim_default.createElement("div", { className: "text-5xl mb-4" }, "\u{1F3A8}"), /* @__PURE__ */ framesbuild_shim_default.createElement("h2", { className: "text-lg font-semibold mb-2" }, t("title", "Filtre")), /* @__PURE__ */ framesbuild_shim_default.createElement("p", { className: "text-sm text-text-dim" }, t("editor_tool_info", "Tento modul je n\xE1stroj SkyFrame Editora. Otvor Editor (ikona \u{1F39B}\uFE0F v\u013Eavo), nahraj s\xFAbor a tento n\xE1stroj n\xE1jde\u0161 v pravom st\u013Apci."))));
}
